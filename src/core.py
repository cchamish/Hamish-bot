...
if __name__ == '__main__':
    ...
    que = EditQueue()
    que.push(title='User:Hamish/沙盒', text=lambda s,t:re.sub(r'[a-zA-Z]', 'P<sub>4</sub>', t),
             summary='Hamish', ts=now()+datetime.timedelta(seconds=20))
    que.push(title='User:Hamish/沙盒', text=lambda s,t:re.sub(r'[a-zA-Z]', 'b', t),
             summary='test', ts=now()+datetime.timedelta(seconds=5))
    que.push(title='User:Hamish/沙盒',
